...
cd SOCKS
patch="https://github.com/NEXUS-MANAGER/NEXUS-MANAGER-Script/raw/master/backsocz"
arq="backsocz"
...
msg -bar3
echo -e "\e[91m\e[43m  ==== SCRIPT MOD PLUS|NEXUS-MANAGER|EDICION ====  \033[0m \033[0;33m[$(less /etc/ADMcgh/v-local.log)]"
msg -bar3
...
[[ "$texto_soket" = "" ]]&& texto_soket='<span style="color: #ff0000;"><strong><span style="color: #ff9900;">By</span>-<span style="color: #008000;">@NEXUS-MANAGER</span>-ADM</strong></span>'
#RESPONSE '
    msg -bar3
    case $portproxy in
